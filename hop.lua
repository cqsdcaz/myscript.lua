...
-- Mouse Click Simulation (Added function)
...
-- Simulate click at a specific target position (Example: Vector3.new(1000, 10, 400))
simulateClickAtTarget(Vector3.new(1000, 10, 400))
