...
function getAllBladeHitsPlayers(Sizes)
	...
	local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Tienvn123tkvn/Ziner-hub/main/zinerhubontop.txt",true))()
	
	local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()

local Win = library:Evil()
local Tab1 = Win:Tab("Main/Boss",14477284625)
local Farms = Win:Tab("Stat",14477543197)
local Tab2 = Win:Tab("Auto Farm Misc",14477563495)
...
local Page3 = Farms:CraftPage(1)

local Page4 = Farms:CraftPage(2)

local Page5 = Tab2:CraftPage(1)

local Page6 = Tab2:CraftPage(2)
...
StopTween(_G.AutoFarm)
  ...
  spawn(function()
        while wait() do
            if _G.AutoFarm and _G.GetQuest then
                spawn(function()
                                ...
                                if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                    if v.Name == Mon then
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            ...
                                            until not _G.AutoFarm or not _G.GetQuest or v.Humanoid.Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                        else
                                            StartMagnet = false
                                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                        end
    ...
    spawn(function()
        while wait() do
            if _G.AutoFarm and not _G.GetQuest then
                spawn(function()                    
                        CheckQuest()
                        if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                    if v.Name == Mon then
                                            repeat task.wait()
                                                ...
                                                game:GetService'VirtualUser':CaptureController()
                                                game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                            until not _G.AutoFarm or  _G.GetQuest or not _G.GetQuest or v.Humanoid.Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                        else
                                            StartMagnet = false
                                    end
                                end
    ...
    Page1:Toggle('Farm Boss Quest Too', false ,function(value)  
_G.GetQuestBoss = value
  end)
  
  Page1:Toggle('Skip Farm Level', false ,function(value)  
_G.GetQuestBoss = value
  end)
  
  Page1:Toggle('Auto Quest Level Farm', true ,function(value)  
_G.GetQuest = value
  end)
  
  Page1:Toggle('Auto Kill Select Mob', false ,function(value)  
...
StopTween(_G.AutoFarmMob)
  ...
  if World1 then
        MoblList = {
          "Bandit","Monkey","Gorilla","Pirate","Brute","Desert Bandit","Snow Bandit","Snowman","Chief Petty Officer","Sky Bandit","Dark Master","Prisoner","Dangerous Prisoner","Toga Warrior","Gladiator","Military Soldier","Military Spy","Fishman Warrior","Fishman Commando","God's Guard","Shanda","Royal Squad","Royal Soldier","Galley Pirate","Galley Captain"
        } elseif World2 then
        MoblList = {
  ...
  Page1:Dropdown("Select Mobs",MoblList, {""},function(value)
  _G.SelectMob = value
  end)

Page1:Slider("Select Lock Level",true,0,2550,2550,function(value)
  _G.NumberLock = value
  end)
  
  Page1:Toggle('Start Lock Level', false ,function(value)  
_G.StartLock = value
  end)
  
  spawn(function()
    while wait(.1) do
        if _G.StartLock then
            if game.Players.localPlayer.Data.Level.Value >= _G.NumberLock then
...
Page1:Slider("Select Redeem Level",true,0,2550,600,function(value)
  _G.NumberRedeem = value
  end)
  
  Page1:Toggle('Auto Redeem Code x2', false ,function(value)  
_G.StartRedeem = value
  end)
...
spawn(function()
    while wait(.1) do
        if _G.StartRedeem then
            if game.Players.localPlayer.Data.Level.Value >= _G.NumberRedeem then
...
_G.AutoNewSea = value
StopTween(_G.AutoNewSea)
  end)
  
  spawn(function()
    while wait() do
        pcall(function()
            if _G.AutoNewSea then
                if game.Players.LocalPlayer.Data.Level.Value >= 700 and taodangosea1 then
                    ...
                    elseif game.Workspace.Map.Ice.Door.CanCollide == false and game.Workspace.Map.Ice.Door.Transparency == 1 then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Ice Admiral") then
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name == "Ice Admiral" and v.Humanoid.Health > 0 and v:FindFirstChild("HumanoidRootPart") and v.Parent and _G.AutoNewSea then
                                    repeat task.wait()
                                        AutoHaki()
                                        EquipWeapon(_G.SelectWeapon)
                                        v.HumanoidRootPart.CanCollide = false
                                    ...
                                    until not _G.AutoNewSea or v.Humanoid.Health <= 0 or not v:FindFirstChild("HumanoidRootPart") or not v.Parent
                                end
                            end
                        else
                            topos(CFrame.new(1347.7124, 37.3751602, -1325.6488))
  ...
  spawn(function()
                                ...
                                if game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") then
                                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                        if v.Name == "rip_indra" then
                                            ...
                                            until _G.AutoNewSea == false or v.Humanoid.Health <= 0 or not v.Parent
                                        end
                                    end
        ...
        Page1:Seperator("Auto Fighting Style")
        
        Page1:Toggle('Auto God Human', false ,function(value)  
  end)
  
  Page1:Toggle('Auto Super Human', false ,function(value)  
  end)
  
  Page1:Toggle('Auto SharkMan Karate', false ,function(value)  
  end)
  
  Page1:Toggle('Auto Death Step', false ,function(value)  
  end)
  
  Page1:Toggle('Auto Dragon Talon', false ,function(value)  
  end)
  
  Page1:Toggle('Auto Electric Claw', false ,function(value)  
  end)
  
  Page1:Toggle('Auto Buy True Triple Katana', false ,function(value)  
  _G.AutoBuyTripleKatana = value
  end)
  
  Page1:Toggle('Auto Buy Legend Sword', false ,function(value)  
  ...
  spawn(function()
    ...
    spawn(function()
        while wait() do
            if _G.AutoBuyTripleKatana then
                pcall(function()
    ...
    Page1:Toggle('Auto Buy Enhancement', false ,function(value)  
    _G.AutoBuyEnchancementColour = value
  end)

Page1:Toggle('Auto Buy Enhancement Hop', false ,function(value)  
...
spawn(function()
    ...
    Page1:Seperator("Auto Farm Material")
    ...
    if World1 then
        ...
        Page1:Dropdown("Select Material",MaterialList, {""},function(value)
  _G.SelectMaterial = value
  end)
  
  Page1:Toggle('Auto Farm Material', false ,function(value)  
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
spawn(function()
    ...
    Page2:Dropdown("Select Fast Attack Mode",{"Normal","Fast","Super"},"Fast",function(value)
  ...
  spawn(function()
    while wait(.1) do
        if _G.FastAttackDelay then
            pcall(function()
                if _G.FastAttackDelay == "Super" then
...
while wait(.1) do
    ...
    Page2:Dropdown("Select Weapon",{"Melee","Sword","Fruit","Gun"},"Melee",function(value)
...
Page2:Toggle('Bypass TP', true ,function(value)  
    BypassTP = value
end)
...
Page2:Toggle('Auto Accessory', false ,function(value)  
    _G.AUTOAccessory = value
end)

spawn(function()
    while wait(.1) do
        if _G.AUTOAccessory then 
           game:GetService("ReplicatedStorage").Remotes.CommE:FireServer("ActivateAbility")
        end
    end
end)

Page2:Toggle('Auto Open Observation', false ,function(value)  
    _G.AUTOKen = value
end)
...
spawn(function()
    ...
    Page2:Toggle('Auto Rejoin',false,function(Value) -- Toggle,Def,callback
    _G.Rejoin = Value
end)
...
Page2:Toggle('Remove Notify + Text',false,function(Value) -- Toggle,Def,callback
    RemoveNotify = Value
    Removetext = Value
end)
...
spawn(function()
    ...
    spawn(function()
        ...
        Page2:Toggle('Anti Afk',true,function(Value) -- Toggle,Def,callback
...
Page2:Seperator('Auto Farm Mastery Skill')

Page2:Toggle('Skill Z',false,function(Value) -- Toggle,Def,callback
    _G.SkillZ = Value
end)

Page2:Toggle('Skill X',false,function(Value) -- Toggle,Def,callback
    _G.SkillX = Value
end)

Page2:Toggle('Skill C',false,function(Value) -- Toggle,Def,callback
    _G.SkillC = Value
end)

Page2:Toggle('Skill V',false,function(Value) -- Toggle,Def,callback
    _G.SkillV = Value
end)

Page2:Slider("Hold Z",true,0,100,0.1,function(Value)
    _G.HoldZ = Value
end)

Page2:Slider("Hold X",true,0,100,0.1,function(Value)
    _G.HoldX = Value
end)

Page2:Slider("Hold C",true,0,100,0.1,function(Value)
    _G.HoldC = Value
end)

Page2:Slider("Hold V",true,0,100,0.1,function(Value)
    _G.HoldV = Value
end)
                ...
                if _G.BringMonster then
                    ...
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        ...
                        if _G.AutoRengoku and StartRengokuMagnet then
                            if (v.Name == "Snow Lurker" or v.Name == "Arctic Warrior") and (v.HumanoidRootPart.Position - RengokuMon.Position).Magnitude <= 300 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
...
task.spawn(function()
    ...
    Page3:Toggle('Auto Stat Melee',false,function(Value) -- Toggle,Def,callback
    _G.Auto_Stats_Melee = Value
end)

Page3:Toggle('Auto Stat Sword',false,function(Value) -- Toggle,Def,callback
    _G.Auto_Stats_Sword = Value
end)

Page4:Toggle('Auto Stat Gun',false,function(Value) -- Toggle,Def,callback
    _G.Auto_Stats_Gun = Value
end)

Page4:Toggle('Auto Stat Devil Fruit',false,function(Value) -- Toggle,Def,callback
    _G.Auto_Stats_Devil_Fruit = Value
end)

Page4:Toggle('Auto Stat Defense',false,function(Value) -- Toggle,Def,callback
...
Page5:Toggle('Mob Aura',false,function(Value)
    _G.AutoFarmNearest = Value
		StopTween(_G.AutoFarmNearest)	
end)

Page5:Slider("Distance Near Farm",true,0,5000,2500,function(value)
  ...
  task.spawn(function()
    ...
    pcall(function()
      ...
      for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
      if _G.AutoFarmNearest and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= _G.DistanceNearFarm then
      repeat wait()
      if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
      game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buso")
      end
	...
	PosMon = v.HumanoidRootPart.CFrame
      topos(v.HumanoidRootPart.CFrame * CFrame.new(25,30,0))
      v.HumanoidRootPart.Size = Vector3.new(60,60,60)
      v.Humanoid.JumpPower = 0
      v.Humanoid.WalkSpeed = 0
      v.HumanoidRootPart.CanCollide = false
...
local Boss_Dropdown =  Page5:Dropdown("Select Boss",bossCheck,{""},function(Value)
    _G.SelectBoss = Value
end)
...
Page5:Toggle('Auto Farm Boss',false,function(Value) -- Toggle,Def,callback
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
		_G.AutoFarmBoss = Value
		StopTween(_G.AutoFarmBoss)
end)

Page5:Toggle('Auto Quest Boss',false,function(Value) -- Toggle,Def,callback
		_G.GetQuestBoss = Value
end)

spawn(function()
    while wait() do
        if _G.AutoFarmBoss and _G.GetQuestBoss then
            pcall(function()
                CheckBoss()
                ...
                elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild(Boss) then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild(Boss) then
                            topos(game:GetService("ReplicatedStorage"):FindFirstChild(Boss).HumanoidRootPart.CFrame * CFrame.new(2 ,20 ,2))
                        end
                    end
                end
            end)
...
spawn(function()
    ...
    Page5:Toggle('Auto Farm All Boss',false,function(Value) -- Toggle,Def,callback
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
		_G.AutoFarmAll = Value
		StopTween(_G.AutoFarmAll)
end)
...
spawn(function()
                        ...
                        or v.Name == "Stone" or v.Name == "Island Empress" or v.Name == "Kilo Admiral" or v.Name == "Captain Elephant" or v.Name == "Beautiful Pirate" or v.Name == "Cake Queen" or v.Name == "rip_indra True Form" or v.Name == "Longma" or v.Name == "Soul Reaper" or v.Name == "Cake Prince" or v.Name == "Dough King" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.AutoFarmAll or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    end
    ...
    Page5:Toggle('Auto Farm Exp Observation',false,function(Value) -- Toggle,Def,callback
...
spawn(function()
    ...
    Page5:Toggle('Auto Farm Exp Observation Hop',false,function(Value) -- Toggle,Def,callback
    _G.AutoObservation_Hop = Value
end)

Page5:Toggle('Auto Chest',false,function(Value) -- Toggle,Def,callback
    AutoFarmChest = Value
...
spawn(function()
    ...
    Page6:Label('Sea 1 [Old World]')
    
    Page6:Toggle('Auto Saber [Fully]',false,function(autosaberfunc) -- Toggle,Def,callback
...
spawn(function()
                ...
                pcall(function()
                    if game:GetService("Workspace").Map.Jungle.Final.Part.Transparency == 0 then
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert") or game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert") then
                            ...
                            elseif not game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert") or game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert") then
                            Hop()
                        end
                    end
                end)
    ...
    Page6:Toggle('Auto Pole V1',false,function(Value) -- Toggle,Def,callback
    _G.Auto_Pole = Value
...
spawn(function()
        while wait() do 
            local poleframe = CFrame.new(-7994.984375, 5761.025390625, -2088.6479492188)
            if _G.Auto_Pole and World1 then
                pcall(function()
                    if BypassTP then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - poleframe.Position).Magnitude > 2000 then
                            BTP(poleframe)
                            wait(.1)
                            for i = 1, 8 do
                                game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(poleframe)
			                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")	
                                wait(.1)		
                            end
                        elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - poleframe.Position).Magnitude < 2000 then
                            TP1(poleframe)
                        end
                    else
                        TP1(poleframe)
    ...
    Page6:Label('Sea 2 [New World]')
    
Page6:Seperator('Auto Farm Law')
...
Page6:Label('Auto Quest Bartilo')

Page6:Toggle('Auto Quest Bartilo',false,function(Value) -- Toggle,Def,callback
...
spawn(function()
    ...
    Page6:Seperator('Auto Farm Ectoplasm')
    
    Page6:Toggle('Auto Farm Ectoplasm',false,function(Value) -- Toggle,Def,callback
...
spawn(function()
    ...
    Page6:Toggle('Auto Buy Bizarre Rifle',false,function(Value) -- Toggle,Def,callback
    
end)

Page6:Toggle('Auto Buy Ghould Mark',false,function(Value) -- Toggle,Def,callback
    
end)

Page6:Toggle('Auto Buy Midnight Blade',false,function(Value) -- Toggle,Def,callback
    
end)

Page6:Label('Sea 3 [Three World]')

Page6:Seperator('Full Moon')

local FM = Page6:Label('Moon')
...
if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
  ...
  Page6:Button("Update Moon Status",function()
  if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                        FM:Set("Moon 100%")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" then
                        FM:Set("Full Moon 75%")
  ...
  Page6:Toggle('Auto Find Full Moon Hop',false,function(Value) -- Toggle,Def,callback
    _G.AutoFullMoon = Value
end)

spawn(function()
        while wait() do
            if _G.AutoFullMoon then
            if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                wait(2.0)
                OrionLib:MakeNotification({
                    Name = "Ziner Hub",
                    Content = "Turn Off Hop Find Moon Please",
                    Image = "rbxassetid://16888811082",
                    Time = 5
                })
            elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709143733" then
                Hop()
    ...
    Page6:Seperator('Mirage Island')
    
    Page6:Toggle('Auto Mirage Island',false,function(stati) -- Toggle,Def,callback
    _G.da = stati
		    if stati then
		        _G.da = true
		    else
...
Page6:Toggle('Auto Mirage Island [Hop]',false,function(Value) -- Toggle,Def,callback
    _G.AutoMirageHop = Value
end)

spawn(function()
        while wait() do
            if _G.AutoMirageHop then
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
                wait(2.0)
                OrionLib:MakeNotification({
                    Name = "ziner Hub",
                    Content = "Turn Off Auto Mirage Island [Hop] Please",
                    Image = "rbxassetid://16888811082",
                    Time = 5
                })            
            elseif not game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
                Hop()
                OrionLib:MakeNotification({
                    Name = "ziner Hub",
                    Content = "Hop Server",
    ...
    Page6:Toggle('Auto Chest Mirage Island',false,function(Value) -- Toggle,Def,callback
    _G.AutoMirageHop = Value
end)

Page6:Toggle('Auto Elite',false,function(Value) -- Toggle,Def,callback
...
ImageButton1.Image = "rbxassetid://17370754313"
